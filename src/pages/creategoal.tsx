...
function CreateGoal() {
  ...
  return (
    ...
    min-h-screen min-w-screen max-h-fit max-w-screen'>
        <Header />
        <div className='mx-auto mt-40 md:mt-0 md:w-3/5 lg:w-2/5'>
            <div
            className='text-3xl font-poppins text-center text-orange-500 my-6'
            >Let's get started with your goal</div>
            <form onSubmit={onSubmit}
            className='container flex flex-col w-[360px] md:w-[400px] mx-auto'>
                    <div className='flex flex-col'>
                        <label className='text-xl text-gray-600 my-4 font-lato font-semibold text-center'>I commit to</label>
                        <input
                    ...
                    <div className='flex flex-col'>
                        <label className='text-xl text-gray-600 my-4 font-lato font-semibold text-center'>I want to complete this goal by</label>
                        <input
                    ...
                    <div className='flex flex-col'>
                        <label className='text-xl text-gray-600 my-4 font-lato font-semibold text-center'>Describe your goal</label>
                        <textarea
                    ...
                    <div className='flex flex-col'>
                        <label className='text-xl text-gray-600 my-4 font-lato font-semibold text-center'>Remind me</label>
                        <div className='container text-center mx-auto flex w-10/12 justify-evenly space-x-6 md:space-x-6'>
                            ...
                            {buttonSelected1 ?
                                ...
                                border-orange-500 text-white hover:scale-105 rounded-xl border-2 w-24'>Daily</button>
                            :
                                <button 
                                type="button" 
                                value={1} 
                                ...
                                border-orange-200 hover:border-orange-500 hover:scale-105 rounded-xl border-2 w-24'>Daily</button>
                            }
                            {/* Weekly */}
                            {buttonSelected2 ?
                                <button 
                                ...
                                name="remaind" 
                                className='text-xl h-10 duration-200 bg-orange-500
                                border-orange-500 text-white hover:scale-105 rounded-xl border-2 w-24'>Weekly</button>
                            :
                                <button 
                                type="button" 
                                value={1} 
                                ...
                                name="remaind" 
                                className='text-xl h-10 hover:text-white hover:bg-orange-500 duration-200 
                                border-orange-200 hover:border-orange-500 hover:scale-105 rounded-xl border-2 w-24'>Weekly</button>
                            }
                            {/* Monthly */}
                            {buttonSelected3 ?
                                <button 
                                ...
                                name="remaind" 
                                className='text-xl h-10 duration-200 bg-orange-500
                                border-orange-500 text-white hover:scale-105 rounded-xl border-2 w-24'>Monthly</button>
                            :
                                <button 
                                type="button" 
                                value={1} 
                                ...
                                name="remaind" 
                                className='text-xl h-10 hover:text-white hover:bg-orange-500 duration-200 
                                border-orange-200 hover:border-orange-500 hover:scale-105 rounded-xl border-2 w-24'>Monthly</button>
                            }
                        </div>
                    </div>
                    {/* <button type="submit"
