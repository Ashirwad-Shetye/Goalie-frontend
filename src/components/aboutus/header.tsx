        ...
        {isLoggedIn ? (
          <>
            <div className="justify-center">
              <ul
                className="hidden mr-48 md:flex items-center mx-8 space-x-8 lg:space-x-12 text-xl 
          ...
          <>
            <div className="justify-center">
              <ul
                className="mr-40 mt-[60px] md:mt-[50px] md:mr-48 md:flex items-center mx-8 space-x-8 lg:space-x-12 text-xl 
